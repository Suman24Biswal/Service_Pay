    ...
    <div className={styles.t}>
      <div className={styles.box}>
        ...
        <div className={styles.btn}>
          ...
          <button onClick={Receipt} style={{ height: '35px', width: '120px', borderRadius: '15px', margin: '0 0 0 63px' }}>Proceed</button>
        </div>
      </div>
    </div>
  );
